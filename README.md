...
See docs/contributing-dictionaries.md for full guidelines and CONTRIBUTING.md for code contributions.
...
Inspiration
Gregg Shorthand — the original stenographic system
Pitman Shorthand — phonetic compression for speed writing
Vannevar Bush's Memex — associative trails through knowledge
